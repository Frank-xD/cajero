...
import java.io.File;
/**
 * ingresas el numero de cuenta a la que deseas transferir
 * @author Frank
 */
public class transferencia extends javax.swing.JFrame {
    ...
    public transferencia() {
        ...
        Titulo.setText(I.leerFila(88,direccion));
    }
    ...
    private void initComponents() {
        ...
        Titulo.setText("Ingrese la cuenta a la que desea transferir");
        Panel1.add(Titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1200, 160));
        ...
        CancelarLayout.setHorizontalGroup(
            ...
            .addComponent(cancelar, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
        );
        ...
        Panel1.add(Mensaje, new org.netbeans.lib.awtextra.AbsoluteConstraints(740, 310, 460, 90));
    ...
    private void Btn2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn2MouseClicked
         if(NumCuenta.getText().length() <= 25){
            if((NumCuenta.getText().length() == 5 || NumCuenta.getText().length() == 12 || NumCuenta.getText().length() == 19 )) 
                NumCuenta.setText(NumCuenta.getText() + " - ");
    ...
    private void Btn10MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_Btn10MouseClicked
        ...
        if(NumCuenta.getText().length()==9 || NumCuenta.getText().length()==16 ||
           ...
           nro = nro.substring(0, nro.length() - 4);}
        else {
            NumCuenta.setText(NumCuenta.getText().substring(0,NumCuenta.getText().length()-1));
            nro = nro.substring(0, nro.length() - 1);}
    ...
    private void aceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_aceptarMouseClicked
        ...
        if (archivoCuenta != null) {
            CantidadTransaferencia a = new CantidadTransaferencia();
            a.setNro(nro);
            a.setVisible(true);
            a.setMenu(m);
            dispose();
