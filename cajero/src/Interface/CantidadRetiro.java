 ...
 * @author Frank
 */
public class CantidadRetiro extends javax.swing.JFrame {
        Idioma I = new Idioma();
    ...
    public CantidadRetiro() {
        ...
        SubTitulo1.setText(I.leerFila(70,direccion));
        SubTitulo2.setText(I.leerFila(71,direccion));
    ...
    private void initComponents() {
        ...
        SubTitulo2.setText("de dinero a retirar");
        jPanel1.add(SubTitulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 110, 690, 70));
        ...
        jPanel1.add(SubTitulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 60, 710, 70));
        ...
        jPanel1.add(Panel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(840, 500, 240, 70));
        ...
        jPanel1.add(Panel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 500, 240, 70));
        ...
        jPanel1.add(Panel01, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 500, 240, 70));
    ...
    private void AceptarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_AceptarMouseClicked
        ...
        if(Monto.getText().equals("")){
            ...
            if(SaldoActual >= monto){
                ...
                r.guardarRegistroOperaciones("-"+Monto.getText(), id, 2,ruta);
                ConfirmRetiro a = new ConfirmRetiro();
                a.setVisible(true);
                a.setMenu(m);
                dispose();
            }else{
                Mensaje.setText(I.leerFila(72,direccion));
            }
        }       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CantidadRetiro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CantidadRetiro().setVisible(true);
            }
        });
    }
